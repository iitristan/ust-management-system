...
function BorrowerForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${process.env.API_URL}/api/borrowing-requests`, formData, {
        headers: {
  ...
  const fetchActiveAssets = async () => {
    try {
      const response = await axios.get(`${process.env.API_URL}/api/assets/active`);
